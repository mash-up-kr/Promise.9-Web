...
- 서버 레포 문서: https://github.com/mash-up-kr/Promise.9-Server/tree/main/docs
- 도메인별 API 명세·화면 매핑: https://github.com/mash-up-kr/Promise.9-Server/tree/main/docs/api (link · folder · auth · common · screen-mapping 등)

파일 읽기 (구 `docs/api-screen-mapping` 브랜치는 삭제됨 — main 으로 조회):
`gh api -H "Accept: application/vnd.github.raw" "repos/mash-up-kr/Promise.9-Server/contents/docs/api/<파일>.md?ref=main"`
