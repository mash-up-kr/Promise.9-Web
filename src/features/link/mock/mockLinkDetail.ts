...
const mockTags: LinkTag[] = [
  ...
  { tagId: 4, name: "퍼널 분석", sourceType: "ai", sortOrder: 3 },
  { tagId: 5, name: "가설 수립", sourceType: "ai", sortOrder: 4 },
];
...
export const mockLinkDetail: LinkDetail = {
  ...
  dominantColor: "#3182F6",
};

/** 폴더 미지정(`folder` null) 상태 — `FolderBadge` "미분류" fallback 검증용 */
